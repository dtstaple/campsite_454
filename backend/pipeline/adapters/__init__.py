...
Shipped so far: PAD-US (public land and legal access) and OSM trails. USGS NHD water
and Recreation.gov campsites are the remaining TM05-13 work.
...
from pipeline.adapters import osm_trails, padus  # noqa: E402,F401  (import order is deliberate)
